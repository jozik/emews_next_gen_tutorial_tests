...
An initial version of the project was created using the EMEWS creator with the following command, #issued from the tutorial# https://github.com/jozik/emews_next_gen_tutorial_tests/tree/main/code[code,window=UC1,pts="noopener,nofollow"] directory:
