...
* https://github.com/emews/emews-tutorial-code/tree/main/uc1[UC1,window=UC1,pts="noopener,nofollow"]
...
* https://github.com/emews/emews-tutorial-code/tree/main/uc4[UC4,window=UC4,pts="noopener,nofollow"]
