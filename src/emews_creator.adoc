...
If you have already installed EMEWS through the <<quickstart,Quickstart section>>, EMEWS Creator is already installed.
...
// TODO: #NOTE: do we need to update all the commit-specific permalinks like the one below?#
...
//See that section for more info // NC TODO
...
// #NC TODO: text about local vs. remote run#
