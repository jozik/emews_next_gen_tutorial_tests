...
#TODO: Suggested for the above section: Explain that Python functions can be called via swift interpreter to streamline. Indicate the pros and cons for doing that versus command line invocation.#
