...
2. Check your R build configuration files, +~/R/Makevars+ and +~/.Renviron+ .  These should be emptyfor EMEWS, however, you can re-add any needed features after you get EMEWS working.
